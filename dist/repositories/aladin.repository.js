...
export const searchBooksFromAladin = async (query, start = 1, maxResults = 30) => {
...
export const getBookDetailFromAladin = async (itemId) => {
...
export const viewBestsellersFromAladin = async (start = 1, maxResults = 30) => {
